...
//String ipUrl = "http://192.168.1.37:5000/ip";
//String climateUrl = "http://192.168.1.37:5000/climate";
//String climateLogUrl = "http://192.168.1.37:5000/climate/log";
...
void loop() {
  ...
  if (error) {
      ...
      String climateEndPoint = climateUrl + "?co2="+co2+"&humidity="+humidity+"&temperature="+temperature;
      ...
      http.end();
      if (logCount >= 60) {
          String climateLogEndPoint = climateLogUrl + "?co2="+co2+"&humidity="+humidity+"&temperature="+temperature;
